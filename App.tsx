...
import { COLORS, DISCLAIMER_KEY } from "./src/config/constants";
        ...
        <View style={disclaimerStyles.card}>
          ...
          <ScrollView style={disclaimerStyles.scroll} showsVerticalScrollIndicator={false}>
            <Text style={disclaimerStyles.body}>
              Copilot provides <Text style={disclaimerStyles.bold}>automated portfolio analysis for informational purposes only.</Text>
              {"\n\n"}
              Nothing in this app constitutes financial advice, investment advice, trading advice, or any other type of advice. The signals, risk scores, and trade recommendations are generated by automated systems and{" "}
